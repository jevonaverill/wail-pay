...
public class WalletContentFragment extends Fragment {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_TRANS,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            final View popupR = layoutInflater.inflate(R.layout.popup_confirm,
                                    null);
                            ...
                            ((TextView) popupR.findViewById(R.id.tvReceivedAmount)).setText
                                    (separated[1]);
    ...
    private boolean doWeHaveRecordAudioPermission() {
        if (ContextCompat.checkSelfPermission(getContext(), android.Manifest.permission
            ...
            ActivityCompat.requestPermissions(getActivity(), new String[]{android.Manifest
                    .permission.RECORD_AUDIO}, RESULT_REQUEST_RECORD_AUDIO);
            return false;
        }
        return true;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
            savedInstanceState) {
        chirpSDK = new ChirpSDK(getContext(), "tRO8YP7HsZeKVmlimYnXWKfOl",
                "TpQ56eYPa4qiClWMoJ3f3lAIKJiWW3bNHiryz0Dsf69Ttt6wrq");
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, CREATE_TRANS,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            Firebase ref = new Firebase("https://wailpay-b8502.firebaseio" +
                                    ".com/transaction/" + resp);

                            String identifier = String.format("%010d", transID);
                            Log.d("test", identifier);
                            //((TextView)getView().findViewById(R.id.txtReceived)).setText
                            // (identifier);
...
//                                        ((TextView) findViewById(R.id.txtStatus)).setText(post
// .getStatus());
//                                    }
//                                }
//
//                                public void onCancelled(FirebaseError firebaseError) {
//                                    System.out.println("The read failed: " + firebaseError
// .getMessage());
//                                }
//                            });
                    ...
                    new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            // Toast.makeText(MainActivity.this,error.toString(),Toast
                            // .LENGTH_LONG).show();
                        }
                    }) {
                @Override
